...
@HiltViewModel(assistedFactory = ModalLyricsViewModel.Factory::class)
class ModalLyricsViewModel @AssistedInject constructor(
    ...
    @AssistedFactory
    interface Factory {
        fun create(audio: Audio?): ModalLyricsViewModel
    }
