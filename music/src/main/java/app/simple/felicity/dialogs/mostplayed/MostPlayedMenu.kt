 ...
 * @author Hamza417
 */
class MostPlayedMenu : ScopedBottomSheetFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.listStyleSeekbar.setStep(list.indexOf(MostPlayedPreferences.getGridSize()))
