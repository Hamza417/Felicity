...
class About : PreferenceFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        headerBinding.title.text = getString(R.string.about)
        headerBinding.icon.setImageResource(R.drawable.ic_info)
        binding.header.setContentView(headerBinding.root)
        binding.recyclerView.setHasFixedSize(false)
        binding.recyclerView.adapter = GenericPreferencesAdapter(createAboutPanel())
