    ...
    private fun setupClickListeners() {
        ...
        headerBinding.gridSize.setOnClickListener { button ->
            SharedScrollViewPopup(
                    ...
                    onMenuItemClick = {
                        when (it) {
                            R.string.one -> MostPlayedPreferences.setGridSize(CommonPreferencesConstants.GRID_SIZE_ONE)
                            R.string.two -> MostPlayedPreferences.setGridSize(CommonPreferencesConstants.GRID_SIZE_TWO)
                            R.string.three -> MostPlayedPreferences.setGridSize(CommonPreferencesConstants.GRID_SIZE_THREE)
                            R.string.four -> MostPlayedPreferences.setGridSize(CommonPreferencesConstants.GRID_SIZE_FOUR)
                            R.string.five -> MostPlayedPreferences.setGridSize(CommonPreferencesConstants.GRID_SIZE_FIVE)
                            R.string.six -> MostPlayedPreferences.setGridSize(CommonPreferencesConstants.GRID_SIZE_SIX)
                        }
                    },
                    onDismiss = {}
            ).show()
        ...
        headerBinding.gridType.setOnClickListener { button ->
            SharedScrollViewPopup(
                    ...
                    onMenuItemClick = {
                        when (it) {
                            R.string.list -> MostPlayedPreferences.setGridType(CommonPreferencesConstants.GRID_TYPE_LIST)
                            R.string.grid -> MostPlayedPreferences.setGridType(CommonPreferencesConstants.GRID_TYPE_GRID)
                        }
                    },
                    onDismiss = {}
            ).show()
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences?, key: String?) {
        ...
        when (key) {
            MostPlayedPreferences.GRID_SIZE_PORTRAIT, MostPlayedPreferences.GRID_SIZE_LANDSCAPE -> {
                ...
                gridLayoutManager?.spanCount = MostPlayedPreferences.getGridSize()
