...
package app.simple.felicity.decorations.layoutmanager.spanned
 ...
 */
open class SpannedGridLayoutManager(val orientation: Orientation, val spans: Int) :
    ...
    fun getTotalHeight(): Int {
        val lastRow = rectsHelper.rows.keys.maxOrNull() ?: 0
        return (lastRow + 1) * rectsHelper.itemSize
    }
