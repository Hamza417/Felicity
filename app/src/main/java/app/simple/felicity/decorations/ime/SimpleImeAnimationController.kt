...
internal class SimpleImeAnimationController {
    ...
    private val animationControlListener by lazy {
        object : WindowInsetsAnimationControlListenerCompat {
             ...
             */
            override fun onReady(controller: WindowInsetsAnimationControllerCompat, types: Int) = onRequestReady(controller)
     ...
     */
    fun startControlRequest(view: View, onRequestReady: ((WindowInsetsAnimationControllerCompat) -> Unit)? = null) {
        ...
        WindowCompat.getInsetsController((view.context as BaseActivity).window, view).controlWindowInsetsAnimation(
    ...
    private fun animateImeToVisibility(visible: Boolean, velocityY: Float? = null) {
        ...
        //        // If we have a current spring animation, cancel it
        //        currentSpringAnimation?.cancel()
        //
        //        // Create a new spring animation
        //
        //        val floatValueHolder = FloatValueHolder()
        //        floatValueHolder.value = controller.currentInsets.bottom.toFloat()
        //
        ...
        //        currentSpringAnimation?.spring?.dampingRatio = SpringForce.DAMPING_RATIO_NO_BOUNCY
        ...
        //        currentSpringAnimation?.spring?.stiffness = SpringForce.STIFFNESS_MEDIUM
        //        currentSpringAnimation?.addEndListener { anim, _, _, _ ->
