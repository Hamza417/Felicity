...
object RecentlyAddedPreferences {
    ...
    const val GRID_SIZE_PORTRAIT = "recently_added_grid_size_portrait"
    const val GRID_SIZE_LANDSCAPE = "recently_added_grid_size_landscape"
    const val GRID_TYPE_PORTRAIT = "recently_added_grid_type_portrait"
    const val GRID_TYPE_LANDSCAPE = "recently_added_grid_type_landscape"
