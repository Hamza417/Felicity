...
/**
 * Persisted display preferences for the Most Skipped panel (layout mode),
 * with separate landscape and portrait values.
 *
 * @author Hamza417
 */
object MostSkippedPreferences {

    const val GRID_SIZE_PORTRAIT = "most_skipped_grid_size_portrait1"
    const val GRID_SIZE_LANDSCAPE = "most_skipped_grid_size_landscape1"
