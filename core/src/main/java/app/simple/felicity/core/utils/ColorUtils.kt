...
object ColorUtils {
    ...
    fun ViewGroup.animateColorChange(endColor: Int) {
        ...
        colorAnim.addUpdateListener { animation ->
            this.backgroundTintList = ColorStateList.valueOf(animation.animatedValue as Int)
        }
        colorAnim.start()
    }
    ...
    fun TextView.animateColorChange(endColor: Int) {
        val colorAnim =
            ValueAnimator.ofObject(ArgbEvaluatorCompat(), this.currentTextColor, endColor)
        colorAnim.duration = 500L
