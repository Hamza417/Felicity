package app.simple.felicity.decorations.lrc;
...
public class LrcView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        try (TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.LrcView)) {
            ...
            if (!isInEditMode()) {
                mIndicatorTextColor = typedArray.getColor(R.styleable.LrcView_indicatorTextColor, ThemeManager.INSTANCE.getAccent().getPrimaryAccentColor());
                mCurrentIndicateLineTextColor = typedArray.getColor(R.styleable.LrcView_currentIndicateLrcColor, ThemeManager.INSTANCE.getAccent().getPrimaryAccentColor());
                mIndicatorLineColor = typedArray.getColor(R.styleable.LrcView_indicatorLineColor, ThemeManager.INSTANCE.getAccent().getPrimaryAccentColor());
            }
