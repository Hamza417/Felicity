...
import app.simple.felicity.decorations.pinch.scale.Scale;
import app.simple.felicity.decorations.pinch.scale.ScaleManager;
...
public class ZoomItemAnimator extends RecyclerView.ItemAnimator implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    }    private final ScaleManager scaleHandler = new ScaleManager(new ScaleManager.OnScaleChangedListener() {
        @Override
