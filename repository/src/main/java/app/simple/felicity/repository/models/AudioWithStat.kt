 ...
 * embedded so all track metadata is accessible, while {@code lastPlayed}, {@code playCount},
 * {@code skipCount}, and {@code replayCount} are pulled in from the {@code song_stats} join.
 *
...
data class AudioWithStat(
        ...
        /** How many times the user went back to hear this song again. */
        @ColumnInfo(name = "replayCount") val replayCount: Int
)
